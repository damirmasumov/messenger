...
INSERT INTO user(name, class, letter, birthday, phone, user_type)VALUES("Петр", 11, "А", "2000-01-01", "+78000000000", "Student");
    ...
    id_zapici AUTO_INCREMENT,
     creator_idi  INT NOT NULL AUTO_INCREMENT,    FOREIGN KEY (creator_idi) references user(creator_id),
      idi  INT NOT NULL AUTO_INCREMENT,    FOREIGN KEY (idi) references user(id)
 );     
    SELECT * FROM chat_massage;    
